...
- **[Waste heat into drinking water](datacenter-water.html)** — a design note: warm-water datacenter
  cooling coupled to membrane distillation, with live arithmetic (litres per megawatt of compute),
  the honest limits, and a ~$200 desk rig that would replace the model's central assumption with a
  measurement.
